...
public class LuceneImplementation {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			indexLocation = resourceDir;
			indexer = new LuceneImplementation(indexLocation);
		} catch (Exception ex) {
		...
		int query_id = 1;
		Scanner queryScan = new Scanner(new File(resourceDir + "/cacm_stem.query.txt"));
		...
		File docFile = new File(resourceDir + "/LUCENE_SCORE_STEMMED_LIST.txt");
